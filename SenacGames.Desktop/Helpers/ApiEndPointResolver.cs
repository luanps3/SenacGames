...
//   SenacGames.Desktop/bin/Debug/net8.0-windows/
//
...
//   "ApiSettings": { "BaseUrl": "https://api.senacgames.com" }
//
...
{
    /// <summary>
    /// Responsável por descobrir automaticamente a URL base da API SenacGames.
    /// Elimina a necessidade de portas hardcoded no código.
    /// </summary>
    /// <remarks>
    /// Ordem de resolução:
    ///   1. launchSettings.json do projeto SenacGames.API (desenvolvimento)
    ...
    public static class ApiEndpointResolver
    {
        ...
        /// </summary>
        /// <returns>
        /// URL base da API (ex: "http://localhost:5223") ou null se não encontrada.
        /// </returns>
